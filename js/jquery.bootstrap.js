    ...
    var alert = function (title, message) {
        ...
        $("<div>" + message + "</div>").dialog({
            ...
            , onClose: function () {
                ...
                {
                    text: model.ok.text, classed: model.ok.classed || "btn-success", click: function () {
                    $(this).dialog("destroy");
                }
                }
            ]
    ...
    var confirm = function (title, message, callback) {
        ...
        $("<div>" + message + "</div>").dialog({
            ...
            , onClose: function () {
                ...
                {
                    text: model.cancel.text, classed: model.cancel.classed || "btn-danger", click: function () {
                    $(this).dialog("destroy");
                }
                }
            ]
            ...
            if (clickHandler) {
                $("li>a", $this).click(function () {
                    ...
                    clickHandler.call(self, {
                        id: $link.attr("data-id"), attributes: attrs ? JSON.parse(attrs) : {}, text: $link.text()
                    }, $link);
                });
            }
        }
